    ...
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <h1 class="text-3xl font-bold mb-6">Új megye létrehozása</h1>
                ...
                <form action="{{ route('counties.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="name" class="block text-gray-700 font-bold mb-2">Megye Név</label>
                        <input type="text" id="name" name="name" value="{{ old('name') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Megye neve" />
                    </div>
